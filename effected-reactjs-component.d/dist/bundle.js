...
function genMsg(callerName, locationStr) {
    return _react2.default.createElement(
        'div',
        { className: 'msg' },
        'If you can see this msg, the function ',
        callerName,
        ' has executed,',
        locationStr,
        ';'
...
var Log = function (_Component) {
    ...
    _createClass(Log, [{
        ...
        value: function render() {
            ...
            var lineInfoStr = line ? line + ' line of ' : '';
            var locationStr = ' in ' + lineInfoStr + ' script file ' + __filename;
            var callerName = void 0;
            try {
                throw new Error();
            } catch (e) {
                var re = /(\w+)@|at (\w+) \(/g,
            ...
            var msgStr = 'If you can see this msg,\nthe function ' + callerName + ' has executed,\n' + locationStr + ';';
            var msgComponent = genMsg(callerName, locationStr);
            var devDeclareMsg = 'This component is just used for dev evironment,\nMake sure remove this component before commit work.';
            console.log('\n            ' + msgStr + '\n        ');
            var screenWidth = document.body.offsetWidth;
            var logBtnScale = '60px';
            var logLeft = screenWidth - parseFloat(logBtnScale) + 'px';
            var logColor = 'rgba(253,189,5, .2)';
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'div',
                        { style: { color: 'rgba(243,112,33,.9)' } },
                        msgComponent
                    ),
                    _react2.default.createElement(
                        'div',
                        { style: { color: 'rgba(41,56,150,.9)' } },
                        devDeclareMsg
                    )
                )
            );
...
var _tests = __webpack_require__(28);
...
function Test() {
    return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(_log2.default, { line: 7 }),
        _react2.default.createElement(_log2.default, { line: 8 }),
        _react2.default.createElement(_log2.default, { line: 9 }),
